...
var WeaponCatalog = []WeaponDef{
	...
	{ID: "AssaultRifle_Cobra", RootPath: "SFXGameContent", Name: "Cobra RPG", Category: "Assault Rifle", PictureFile: "AssaultRifle_Cobra.webp"},
	...
	{ID: "AssaultRifle_Prothean_MP", RootPath: "SFXGameContentDLC_CON_MP2", Name: "Prothean Particle Rifle", Category: "Assault Rifle", PictureFile: "AssaultRifle_Prothean_MP.webp"},
	{ID: "AssaultRifle_Reckoning", RootPath: "SFXGameContent", Name: "Reckoning", Category: "Assault Rifle", PictureFile: "AssaultRifle_Reckoning.webp"}, //This is not in game.
	...
	{ID: "AssaultRifle_Saber", RootPath: "SFXGameContent", Name: "N7 Saber", Category: "Assault Rifle", PictureFile: "AssaultRifle_Saber.webp"},
	{ID: "AssaultRifle_Spitfire", RootPath: "SFXGameContentDLC_CON_MP5", Name: "Spitfire", Category: "Assault Rifle", PictureFile: "AssaultRifle_Spitfire.webp"},
	...
	{ID: "Pistol_Bloodpack_MP", RootPath: "SFXGameContentDLC_CON_MP5", Name: "Blood Pack Punisher", Category: "Pistol", PictureFile: "Pistol_Bloodpack_MP.webp"},
	{ID: "Pistol_Carnifex", RootPath: "SFXGameContent", Name: "Carnifex", Category: "Pistol", PictureFile: "Pistol_Carnifex.webp"},
	{ID: "Pistol_Eagle", RootPath: "SFXGameContent", Name: "Eagle", Category: "Pistol", PictureFile: "Pistol_Eagle.webp"},
	{ID: "Pistol_Ivory", RootPath: "SFXGameContent", Name: "Ivory", Category: "Pistol", PictureFile: "Pistol_Ivory.webp"},
	{ID: "Pistol_Phalanx", RootPath: "SFXGameContent", Name: "Phalanx", Category: "Pistol", PictureFile: "Pistol_Phalanx.webp"},
	{ID: "Pistol_Predator", RootPath: "SFXGameContent", Name: "Predator", Category: "Pistol", PictureFile: "Pistol_Predator.webp"},
	{ID: "Pistol_Scorpion", RootPath: "SFXGameContent", Name: "Scorpion", Category: "Pistol", PictureFile: "Pistol_Scorpion.webp"},
	{ID: "Pistol_Silencer_MP", RootPath: "SFXGameContentDLC_CON_MP5", Name: "N7 Eagle", Category: "Pistol", PictureFile: "Pistol_Silencer_MP.webp"},
	{ID: "Pistol_Talon", RootPath: "SFXGameContent", Name: "Talon", Category: "Pistol", PictureFile: "Pistol_Talon.webp"},
	{ID: "Pistol_Thor", RootPath: "SFXGameContent", Name: "Thor", Category: "Pistol", PictureFile: "Pistol_Thor.webp"},

	// ---- Shotguns ----------------------------------------------------------
	{ID: "Shotgun_Assault", RootPath: "SFXGameContentDLC_CON_MP3", Name: "Piranha", Category: "Shotgun", PictureFile: "Shotgun_Assault.webp"},
	{ID: "Shotgun_Claymore", RootPath: "SFXGameContent", Name: "Claymore", Category: "Shotgun", PictureFile: "Shotgun_Claymore.webp"},
	{ID: "Shotgun_Crusader", RootPath: "SFXGameContent", Name: "Crusader", Category: "Shotgun", PictureFile: "Shotgun_Crusader.webp"},
	{ID: "Shotgun_Disciple", RootPath: "SFXGameContent", Name: "Disciple", Category: "Shotgun", PictureFile: "Shotgun_Disciple.webp"},
	{ID: "Shotgun_Eviscerator", RootPath: "SFXGameContent", Name: "Eviscerator", Category: "Shotgun", PictureFile: "Shotgun_Eviscerator.webp"},
	...
	{ID: "Shotgun_Katana", RootPath: "SFXGameContent", Name: "Katana", Category: "Shotgun", PictureFile: "Shotgun_Katana.webp"},
	...
	{ID: "Shotgun_Raider", RootPath: "SFXGameContent", Name: "Raider", Category: "Shotgun", PictureFile: "Shotgun_Raider.webp"},
	...
	{ID: "Shotgun_Scimitar", RootPath: "SFXGameContent", Name: "Scimitar", Category: "Shotgun", PictureFile: "Shotgun_Scimitar.webp"},
	{ID: "Shotgun_Striker", RootPath: "SFXGameContent", Name: "Wraith", Category: "Shotgun", PictureFile: "Shotgun_Striker.webp"},

	// ---- SMGs --------------------------------------------------------------
	{ID: "SMG_Bloodpack_MP", RootPath: "SFXGameContentDLC_CON_MP5", Name: "Blood Pack SMG", Category: "SMG", PictureFile: "SMG_Bloodpack_MP.webp"},
	{ID: "SMG_Collector", RootPath: "SFXGameContentDLC_CON_MP4", Name: "Collector SMG", Category: "SMG", PictureFile: "SMG_Collector.webp"},
	{ID: "SMG_Geth", RootPath: "SFXGameContentDLC_CON_MP1", Name: "Geth SMG", Category: "SMG", PictureFile: "SMG_Geth.webp"},
	{ID: "SMG_Hornet", RootPath: "SFXGameContent", Name: "Hornet", Category: "SMG", PictureFile: "SMG_Hornet.webp"},
	{ID: "SMG_Hurricane", RootPath: "SFXGameContent", Name: "Hurricane", Category: "SMG", PictureFile: "SMG_Hurricane.webp"},
	{ID: "SMG_Locust", RootPath: "SFXGameContent", Name: "Locust", Category: "SMG", PictureFile: "SMG_Locust.webp"},
	{ID: "SMG_Shuriken", RootPath: "SFXGameContent", Name: "Shuriken", Category: "SMG", PictureFile: "SMG_Shuriken.webp"},
	{ID: "SMG_Tempest", RootPath: "SFXGameContent", Name: "Tempest", Category: "SMG", PictureFile: "SMG_Tempest.webp"},
	...
	{ID: "SniperRifle_Incisor", RootPath: "SFXGameContent", Name: "Incisor", Category: "Sniper Rifle", PictureFile: "SniperRifle_Incisor.webp"},
	{ID: "SniperRifle_Indra", RootPath: "SFXGameContent", Name: "Indra", Category: "Sniper Rifle", PictureFile: "SniperRifle_Indra.webp"},
	{ID: "SniperRifle_Javelin", RootPath: "SFXGameContent", Name: "Javelin", Category: "Sniper Rifle", PictureFile: "SniperRifle_Javelin.webp"},
	{ID: "SniperRifle_Mantis", RootPath: "SFXGameContent", Name: "Mantis", Category: "Sniper Rifle", PictureFile: "SniperRifle_Mantis.webp"},
	{ID: "SniperRifle_Raptor", RootPath: "SFXGameContent", Name: "Raptor", Category: "Sniper Rifle", PictureFile: "SniperRifle_Raptor.webp"},
	...
	{ID: "SniperRifle_Valiant", RootPath: "SFXGameContent", Name: "Valiant", Category: "Sniper Rifle", PictureFile: "SniperRifle_Valiant.webp"},
	{ID: "SniperRifle_Viper", RootPath: "SFXGameContent", Name: "Viper", Category: "Sniper Rifle", PictureFile: "SniperRifle_Viper.webp"},
	{ID: "SniperRifle_Widow", RootPath: "SFXGameContent", Name: "Widow", Category: "Sniper Rifle", PictureFile: "SniperRifle_Widow.webp"},
}
