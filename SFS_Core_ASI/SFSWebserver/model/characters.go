...
var CharacterCatalog = []CharacterDef{
	...
	{ID: "AdeptN7", Name: "N7 Fury", SubClass: "Adept", PictureFile: "MP_AllianceADP.webp",
		PowerIDs: [5]string{"AnnihilationSphere", "SFXPowerCustomActionMP_DarkChannel", "SFXPowerCustomActionMP_Throw", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "InfiltratorN7", Name: "N7 Shadow", SubClass: "Infiltrator", PictureFile: "MP_AllianceINF.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "ElectricSlash", "ShadowStrike", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelN7", Name: "N7 Paladin", SubClass: "Sentinel", PictureFile: "MP_AllianceSEN.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_EnergyDrain", "SFXPowerCustomActionMP_Incinerate", "CryoCone", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "VanguardN7", Name: "N7 Slayer", SubClass: "Vanguard", PictureFile: "MP_AllianceVAN.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_BioticCharge", "PalmBlaster", "SonicSlash", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "AdeptAsariCommando", Name: "Asari Justicar", SubClass: "Adept", PictureFile: "MP_AsariComm.webp",
		PowerIDs: [5]string{"BubbleShield", "SFXPowerCustomActionMP_Reave", "SFXPowerCustomActionMP_Pull", "SFXPowerCustomActionMP_AsariPassive", "SFXPowerCustomActionMP_AsariMeleePassive"}},
	{ID: "InfiltratorAsari", Name: "Asari Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_AsariINF.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_DarkChannel", "SFXPowerCustomActionMP_Warp", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelAsari", Name: "Asari Valkyrie", SubClass: "Sentinel", PictureFile: "MP_AsariSEN.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_TechArmor", "SFXPowerCustomActionMP_Warp", "AnnihilationSphere", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "SoldierBatarian", Name: "Batarian Soldier", SubClass: "Soldier", PictureFile: "MP_Batarian.webp",
		PowerIDs: [5]string{"BatarianAttack", "BatarianArmor", "SFXPowerCustomActionMP_InfernoGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "AdeptBatarian", Name: "Batarian Adept", SubClass: "Adept", PictureFile: "MP_BatarianADP.webp",
		PowerIDs: [5]string{"Lash", "SFXPowerCustomActionMP_Warp", "SFXPowerCustomActionMP_BioticGrenade", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "VanguardBatarian", Name: "Batarian Vanguard", SubClass: "Vanguard", PictureFile: "MP_BatarianVAN.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_BioticCharge", "Lash", "BatarianArmor", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "SoldierHumanMaleBF3", Name: "N7 Soldier (BF3)", SubClass: "Soldier", PictureFile: "MP_BF_HMM0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_AdrenalineRush", "SFXPowerCustomActionMP_Carnage", "SFXPowerCustomActionMP_FragGrenade", "MPPassive", "MPMeleePassive"}},

	// ---- Cerberus ----------------------------------------------------------
	{ID: "AdeptHumanMaleCerberus", Name: "Cerberus Adept", SubClass: "Adept", PictureFile: "MP_Cerberus.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Singularity", "WhipSmash", "Lash", "MPPassive", "MPMeleePassive"}},
	{ID: "VanguardHumanMaleCerberus", Name: "Cerberus Vanguard", SubClass: "Vanguard", PictureFile: "MP_Cerberus.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_BioticCharge", "WhipSmash", "Lash", "MPPassive", "MPMeleePassive"}},

	// ---- Collectors --------------------------------------------------------
	{ID: "AdeptCollector", Name: "Collector Adept", SubClass: "Adept", PictureFile: "MP_CollectADP.webp",
		PowerIDs: [5]string{"DarkSingularity", "SeekerSwarm", "SFXPowerCustomActionMP_DarkChannel", "MPPassive", "MPMeleePassive"}},

	// ---- Drell -------------------------------------------------------------
	{ID: "AdeptDrell", Name: "Drell Adept", SubClass: "Adept", PictureFile: "MP_Drell0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Reave", "SFXPowerCustomActionMP_Pull", "SFXPowerCustomActionMP_BioticGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "InfiltratorDrell", Name: "Drell Assassin", SubClass: "Infiltrator", PictureFile: "MP_DrellINF.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "HomingGrenade", "ReconMine", "MPPassive", "MPMeleePassive"}},
	{ID: "VanguardDrell", Name: "Drell Vanguard", SubClass: "Vanguard", PictureFile: "MP_Drell0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_BioticCharge", "SFXPowerCustomActionMP_Pull", "SFXPowerCustomActionMP_BioticGrenade", "MPPassive", "MPMeleePassive"}},

	// ---- Female Bot --------------------------------------------------------
	{ID: "InfiltratorFembot", Name: "Infiltrator Bot", SubClass: "Infiltrator", PictureFile: "MP_FBotINF.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_CryoBlast", "RepairMatrix", "MPPassive", "MPMeleePassive"}},

	// ---- Geth --------------------------------------------------------------
	{ID: "EngineerGeth", Name: "Geth Engineer", SubClass: "Engineer", PictureFile: "MP_GethEngineer.webp",
		PowerIDs: [5]string{"GethTurret", "Supercharge", "SFXPowerCustomActionMP_Overload", "MPPassive", "MPMeleePassive"}},
	{ID: "InfiltratorGeth", Name: "Geth Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_GethInfiltrator.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_ProximityMine", "Supercharge", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "SoldierGeth", Name: "Geth Soldier", SubClass: "Soldier", PictureFile: "MP_GethSLD.webp",
		PowerIDs: [5]string{"Flamer", "SFXPowerCustomActionMP_Fortification", "Supercharge", "MPPassive", "MPMeleePassive"}},

	// ---- Krogan ------------------------------------------------------------
	{ID: "SoldierKrogan", Name: "Krogan Soldier", SubClass: "Soldier", PictureFile: "MP_Krogan0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Fortification", "SFXPowerCustomActionMP_Carnage", "SFXPowerCustomActionMP_InfernoGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "AdeptKrogan", Name: "Krogan Adept", SubClass: "Adept", PictureFile: "MP_KroganADP.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Barrier", "SFXPowerCustomActionMP_Warp", "SFXPowerCustomActionMP_Shockwave", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelKrogan", Name: "Krogan Sentinel", SubClass: "Sentinel", PictureFile: "MP_Krogan0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_TechArmor_Krogan", "SFXPowerCustomActionMP_Incinerate", "SFXPowerCustomActionMP_LiftGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "VanguardKrogan", Name: "Krogan Battlemaster", SubClass: "Vanguard", PictureFile: "MP_KroganBM.webp",
		PowerIDs: [5]string{"KroganBioticCharge", "SFXPowerCustomActionMP_Carnage", "SFXPowerCustomActionMP_Barrier", "MPPassive", "MPMeleePassive"}},
	...
	{ID: "EngineerQuarian", Name: "Quarian Engineer", SubClass: "Engineer", PictureFile: "MP_Quarian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_SentryTurret", "SFXPowerCustomActionMP_Incinerate", "SFXPowerCustomActionMP_CryoBlast", "MPPassive", "MPMeleePassive"}},
	{ID: "InfiltratorQuarian", Name: "Quarian Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_Quarian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_StickyGrenade", "SFXPowerCustomActionMP_AIHacking", "MPPassive", "MPMeleePassive"}},
	{ID: "InfiltratorQuarianMale", Name: "Quarian Male Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_QuarianMale0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "Damping", "EMPGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "EngineerQuarianMale", Name: "Quarian Male Engineer", SubClass: "Engineer", PictureFile: "MP_QuarianMale0.webp",
		PowerIDs: [5]string{"Damping", "SFXPowerCustomActionMP_Incinerate", "EMPGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "SoldierMQuarian", Name: "Quarian Male Soldier", SubClass: "Soldier", PictureFile: "MP_QuarianMSLD.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Marksman", "Damping", "SFXPowerCustomActionMP_AIHacking", "MPPassive", "MPMeleePassive"}},

	// ---- Salarian ----------------------------------------------------------
	{ID: "EngineerSalarian", Name: "Salarian Engineer", SubClass: "Engineer", PictureFile: "MP_Salarian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_EnergyDrain", "SFXPowerCustomActionMP_Decoy", "SFXPowerCustomActionMP_Incinerate", "MPPassive", "MPMeleePassive"}},
	{ID: "InfiltratorSalarian", Name: "Salarian Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_Salarian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_ProximityMine", "SFXPowerCustomActionMP_EnergyDrain", "MPPassive", "MPMeleePassive"}},

	// ---- Turian ------------------------------------------------------------
	{ID: "SoldierTurian", Name: "Turian Soldier", SubClass: "Soldier", PictureFile: "MP_Turian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Marksman", "SFXPowerCustomActionMP_ConcussiveShot", "SFXPowerCustomActionMP_ProximityMine", "MPPassive", "MPMeleePassive"}},
	{ID: "EngineerTurian", Name: "Turian Engineer", SubClass: "Engineer", PictureFile: "MP_TurianENG.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_SentryTurret", "SFXPowerCustomActionMP_AIHacking", "HomingGrenade", "MPPassive", "MPMeleePassive"}},
	{ID: "N7InfiltratorTurian", Name: "Turian Infiltrator", SubClass: "Infiltrator", PictureFile: "MP_TurianINF.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Cloak", "StimPack", "SFXPowerCustomActionMP_Overload", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelTurian", Name: "Turian Sentinel", SubClass: "Sentinel", PictureFile: "MP_Turian0.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_TechArmor_Turian", "SFXPowerCustomActionMP_Warp", "SFXPowerCustomActionMP_Overload", "MPPassive", "MPMeleePassive"}},
	{ID: "N7SoldierTurian", Name: "Turian Havoc", SubClass: "Soldier", PictureFile: "MP_TurianSLD.webp",
		PowerIDs: [5]string{"JetPackCharge", "StimPack", "SFXPowerCustomActionMP_CryoBlast", "MPPassive", "MPMeleePassive"}},
	{ID: "VanguardTurianFemale", Name: "Cabal Vanguard", SubClass: "Vanguard", PictureFile: "MP_TurianVAN.webp",
		PowerIDs: [5]string{"HavocStrike", "StimPack", "SFXPowerCustomActionMP_CryoBlast", "MPPassive", "MPMeleePassive"}},

	// ---- Volus -------------------------------------------------------------
	{ID: "AdeptVolus", Name: "Volus Adept", SubClass: "Adept", PictureFile: "MP_VolusADP.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_Stasis", "BioticOrbs", "SFXPowerCustomActionMP_GethShieldBoost", "MPPassive", "MPMeleePassive"}},
	{ID: "EngineerVolus", Name: "Volus Engineer", SubClass: "Engineer", PictureFile: "MP_VolusENG.webp",
		PowerIDs: [5]string{"ReconMine", "SFXPowerCustomActionMP_ProximityMine", "SFXPowerCustomActionMP_GethShieldBoost", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelVolus", Name: "Volus Engineer II", SubClass: "Sentinel", PictureFile: "MP_VolusENG2.webp",
		PowerIDs: [5]string{"Decoy_Volus", "SFXPowerCustomActionMP_CombatDrone", "SFXPowerCustomActionMP_GethShieldBoost", "MPPassive", "MPMeleePassive"}},
	{ID: "VanguardVolus", Name: "Volus Protector", SubClass: "Vanguard", PictureFile: "MP_VolusVAN.webp",
		PowerIDs: [5]string{"SFXPowerCustomActionMP_BioticCharge", "SFXPowerCustomActionMP_GethShieldBoost", "BioticOrbs", "MPPassive", "MPMeleePassive"}},

	// ---- Vorcha ------------------------------------------------------------
	{ID: "SoldierVorcha", Name: "Vorcha Soldier", SubClass: "Soldier", PictureFile: "MP_Vorcha.webp",
		PowerIDs: [5]string{"Bloodlust", "Flamer", "SFXPowerCustomActionMP_Carnage", "MPPassive", "MPMeleePassive"}},
	{ID: "EngineerVorcha", Name: "Vorcha Engineer", SubClass: "Engineer", PictureFile: "MP_VorchaENG.webp",
		PowerIDs: [5]string{"BatarianNet", "SFXPowerCustomActionMP_Incinerate", "Bloodlust", "MPPassive", "MPMeleePassive"}},
	{ID: "SentinelVorcha", Name: "Vorcha Sentinel", SubClass: "Sentinel", PictureFile: "MP_VorchaENG.webp",
		PowerIDs: [5]string{"Bloodlust", "Flamer", "SFXPowerCustomActionMP_BioticGrenade", "MPPassive", "MPMeleePassive"}},
