...
type CharacterDef struct {
	...
	HasUniqueDodge      bool
	// BuggedLightMelee/HeavyMelee/Dodge marks an override as having a known issue in ME3 MP.
	// The selector will show an amber warning and let the player confirm the assignment.
	BuggedLightMelee bool
	BuggedHeavyMelee bool
	BuggedDodge      bool
	// BuggedCustomActionMessage overrides the default warning body text shown when a flagged
	// override is selected. When empty the server generates a generic fallback message.
	BuggedCustomActionMessage string

	// VoiceIDs lists which VoiceDef IDs are valid voice choices when this
	// character is selected as an appearance. Set this in the catalog to restrict
	// the voice picker to a specific subset — e.g. a Turian Soldier that should
	// only offer certain Turian male voices, not all Turian entries. When nil,
	// CompatibleVoiceCharsForChar falls back to species-level filtering.
	VoiceIDs []string
}
...
var CharacterCatalog = []CharacterDef{ // ---- Human base classes ------------------------------------------------
	{
		ID:                  "AdeptHumanFemale",
		IDLook:              "HumanFemaleRecon",
		Name:                "Human Adept (Female)",
		SubClass:            "Adept",
		Species:             []Species{SpeciesHuman, SpeciesAsari},
		PictureFile:         "AdeptHumanFemale.webp",
		...
		VoiceIDs:            []string{"AdeptHumanFemale", "AdeptAsari"},
		HasUniqueHeavyMelee: true,
		HasUniqueDodge:      true,
		HasUniqueLightMelee: true,
	},
	{
		ID:          "AdeptHumanMale",
		IDLook:      "HumanMaleRecon",
		Name:        "Human Adept (Male)",
		SubClass:    "Adept",
		Species:     []Species{SpeciesHuman},
		PictureFile: "AdeptHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_Singularity", "SFXPowerCustomActionMP_Warp", "SFXPowerCustomActionMP_Shockwave", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Adept"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Adept",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                  "EngineerHumanFemale",
		IDLook:              "HumanFemaleDefault",
		Name:                "Human Engineer (Female)",
		SubClass:            "Engineer",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "EngineerHumanFemale.webp",
	...
	{
		ID:          "EngineerHumanMale",
		IDLook:      "HumanMaleDefault",
		Name:        "Human Engineer (Male)",
		SubClass:    "Engineer",
		Species:     []Species{SpeciesHuman},
		PictureFile: "EngineerHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_CombatDrone", "SFXPowerCustomActionMP_Incinerate", "SFXPowerCustomActionMP_Overload", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Engineer"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Engineer",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                  "InfiltratorHumanFemale",
		IDLook:              "HumanFemaleDefault",
		Name:                "Human Infiltrator (Female)",
		SubClass:            "Infiltrator",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "InfiltratorHumanFemale.webp",
	...
	{
		ID:          "InfiltratorHumanMale",
		IDLook:      "HumanMaleDefault",
		Name:        "Human Infiltrator (Male)",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesHuman},
		PictureFile: "InfiltratorHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_Cloak", "SFXPowerCustomActionMP_CryoBlast", "SFXPowerCustomActionMP_StickyGrenade", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Infiltrator"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Infiltrator",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                  "SentinelHumanFemale",
		IDLook:              "HumanFemaleRecon",
		Name:                "Human Sentinel (Female)",
		SubClass:            "Sentinel",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "SentinelHumanFemale.png",
	...
	{
		ID:          "SentinelHumanMale",
		IDLook:      "HumanMaleRecon",
		Name:        "Human Sentinel (Male)",
		SubClass:    "Sentinel",
		Species:     []Species{SpeciesHuman},
		PictureFile: "SentinelHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_TechArmor", "SFXPowerCustomActionMP_Warp", "SFXPowerCustomActionMP_Throw", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Sentinel"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Sentinel",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                  "SoldierHumanFemale",
		IDLook:              "HumanFemaleDeathmask",
		Name:                "Human Soldier (Female)",
		SubClass:            "Soldier",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "SoldierHumanFemale.webp",
	...
	{
		ID:          "SoldierHumanMale",
		IDLook:      "HumanMaleDeathmask",
		Name:        "Human Soldier (Male)",
		SubClass:    "Soldier",
		Species:     []Species{SpeciesHuman},
		PictureFile: "SoldierHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_AdrenalineRush", "SFXPowerCustomActionMP_ConcussiveShot", "SFXPowerCustomActionMP_FragGrenade", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Soldier"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Soldier",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                  "VanguardHumanFemale",
		IDLook:              "HumanFemaleDeathmask",
		Name:                "Human Vanguard (Female)",
		SubClass:            "Vanguard",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "VanguardHumanFemale.webp",
	...
	{
		ID:          "VanguardHumanMale",
		IDLook:      "HumanMaleDeathmask",
		Name:        "Human Vanguard (Male)",
		SubClass:    "Vanguard",
		Species:     []Species{SpeciesHuman, SpeciesBatarian},
		PictureFile: "VanguardHumanMale.webp",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_BioticCharge", "SFXPowerCustomActionMP_Shockwave", "SFXPowerCustomActionMP_Discharge", "SFXPowerCustomActionMP_HumanPassive", "SFXPowerCustomActionMP_HumanMeleePassive_Vanguard"},
		RootPath:    "BioChar_MPPlayers.Archetypes.Vanguard",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	...
	// ---- Alliance N7 classes -----------------------------------------------
	{
		...
		SubClass:            "Adept",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceADP.webp",
	...
	},
	{
		...
		SubClass:            "Engineer",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceENG.webp",
	...
	},
	{
		...
		SubClass:            "Infiltrator",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceINF.webp",
		...
		RootPath:            "BioChar_DLC_MP3_MPPlayers",
		ArchetypeID:         "Infiltrator_N7",
		HasUniqueHeavyMelee: true,
		HasUniqueDodge:      true,
		HasUniqueLightMelee: true,
		BuggedLightMelee:    true,
		BuggedHeavyMelee:    true,
		VoiceIDs:            []string{"AdeptHumanFemale", "AdeptAsari"},
	},
	{
		ID:                  "SentinelN7",
		...
		SubClass:            "Sentinel",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceSEN.webp",
	...
	},
	{
		...
		SubClass:            "Soldier",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceSOL.webp",
	...
	},
	{
		...
		SubClass:            "Vanguard",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_AllianceVAN.webp",
	...
	// ---- Asari -------------------------------------------------------------
	{
		...
		Name:                "Asari Adept",
		SubClass:            "Adept",
		Species:             []Species{SpeciesAsari},
		PictureFile:         "MP_Asari0.webp",
	...
	{
		ID:          "AdeptAsariCommando",
		IDLook:      "AsariCommando",
		Name:        "Asari Justicar",
		SubClass:    "Adept",
		Species:     []Species{SpeciesAsari},
		PictureFile: "MP_AsariComm.webp",
		...
		ArchetypeID: "AsariCommando_Adept",
		VoiceIDs:    []string{"AdeptHumanFemale", "AdeptAsari"},
	},
	{
		ID:          "InfiltratorAsari",
		IDLook:      "AsariDefault",
		Name:        "Asari Infiltrator",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesAsari},
		PictureFile: "MP_AsariINF.webp",
	...
	{
		ID:                  "SoldierBatarian",
		IDLook:              "BatarianDefault",
		Name:                "Batarian Soldier",
		SubClass:            "Soldier",
		Species:             []Species{SpeciesBatarian},
		PictureFile:         "MP_Batarian.webp",
		...
		RootPath:            "BioChar_DLC_MP1_MPPlayers.Archetypes",
		HasUniqueHeavyMelee: true,
		VoiceIDs:            []string{"SoldierBatarian"},
	},
	{
		ID:          "AdeptBatarian",
		IDLook:      "BatarianDefault",
		...
		SubClass:    "Adept",
		Species:     []Species{SpeciesBatarian},
		PictureFile: "MP_BatarianADP.webp",
		...
		RootPath:    "BioChar_DLC_MP4_MPPlayers",
		ArchetypeID: "Adept_Batarian",
		VoiceIDs:    []string{"SoldierBatarian"},
	},
	{
		ID:          "SentinelBatarian",
		IDLook:      "BatarianDefault",
		Name:        "Batarian Sentinel",
		SubClass:    "Sentinel",
		Species:     []Species{SpeciesBatarian},
		PictureFile: "MP_Batarian.webp",
	...
	},
	{
		ID:          "VanguardBatarian",
		IDLook:      "BatarianDefault",
		Name:        "Batarian Vanguard",
		SubClass:    "Vanguard",
		Species:     []Species{SpeciesBatarian},
		PictureFile: "MP_BatarianVAN.webp",
	...
	{
		ID:          "SoldierHumanMaleBF3",
		IDLook:      "",
		Name:        "Soldier (BF3)",
		SubClass:    "Soldier",
		Species:     []Species{SpeciesHuman},
		PictureFile: "MP_BF_HMM0.webp",
	...
	// ---- Cerberus ----------------------------------------------------------
	{
		ID:          "AdeptHumanMaleCerberus",
		IDLook:      "HumanCerberus",
		Name:        "Cerberus Adept",
		SubClass:    "Adept",
		Species:     []Species{SpeciesHuman},
		PictureFile: "MP_Cerberus.webp",
		...
		ArchetypeID: "CerberusMale_Adept",
		VoiceIDs:    []string{"AdeptHumanMale", "SoldierN7"},
	},
	{
		ID:                        "VanguardHumanMaleCerberus",
		IDLook:                    "HumanCerberus",
		...
		RootPath:                  "BioChar_DLC_MP2_MPPlayers.Archetypes",
		ArchetypeID:               "CerberusMale_Vanguard",
		VoiceIDs:                  []string{"AdeptHumanMale", "SoldierN7"},
		HasUniqueHeavyMelee:       true,
		HasUniqueLightMelee:       true,
		BuggedHeavyMelee:          true,
		BuggedCustomActionMessage: "Heavy Melee works, but the Sound Effects played are distinctly male, so may be distracting on female characters.",
	},
	...
	// ---- Collectors --------------------------------------------------------
	{
		ID:                  "AdeptCollector",
		IDLook:              "",
		Name:                "Collector Adept",
		SubClass:            "Adept",
		Species:             []Species{SpeciesCollector},
		PictureFile:         "MP_CollectADP.webp",
		...
		VoiceIDs:            []string{"AdeptCollector"},
		HasUniqueHeavyMelee: true,
		HasUniqueDodge:      true,
		HasUniqueLightMelee: true,
	},
	...
	// ---- Drell -------------------------------------------------------------
	{
		...
		Name:                "Drell Adept",
		SubClass:            "Adept",
		Species:             []Species{SpeciesDrell},
		PictureFile:         "MP_Drell0.webp",
	...
	// ---- Female Bot --------------------------------------------------------
	{
		...
		IDLook:                    "",
		Name:                      "Infiltrator Bot",
		SubClass:                  "Infiltrator",
		Species:                   []Species{SpeciesAndroid},
		PictureFile:               "MP_FBotINF.webp",
		...
		VoiceIDs:                  []string{"InfiltratorFembot"},
		HasUniqueHeavyMelee:       true,
		HasUniqueDodge:            true,
		HasUniqueLightMelee:       true,
		BuggedHeavyMelee:          true,
		BuggedCustomActionMessage: "Heavy Melee works, but the Sound Effects played are that of the Infiltrator Unit",
	},
	...
	// ---- Geth --------------------------------------------------------------
	{
		...
		Name:                "Geth Engineer",
		SubClass:            "Engineer",
		Species:             []Species{SpeciesGeth},
		PictureFile:         "MP_GethEngineer.webp",
		...
		RootPath:            "BioChar_DLC_MP1_MPPlayers.Archetypes",
		ArchetypeID:         "Geth_Engineer",
		HasUniqueDodge:      true,
		HasUniqueLightMelee: true,
		VoiceIDs:            []string{"InfiltratorGeth"},
	},
	{
		ID:          "InfiltratorGeth",
		IDLook:      "GethDefault",
		Name:        "Geth Infiltrator",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesGeth},
		PictureFile: "MP_GethInfiltrator.webp",
	...
	},
	{
		...
		IDLook:                    "GethJuggernaut",
		Name:                      "Geth Juggernaut",
		SubClass:                  "Soldier",
		Species:                   []Species{SpeciesGeth},
		PictureFile:               "MP_GethPSLD.webp",
		...
		VoiceIDs:                  []string{"SoldierGethDestroyer"},
		HasUniqueHeavyMelee:       true,
		HasUniqueLightMelee:       true,
		BuggedHeavyMelee:          true,
		BuggedLightMelee:          true,
		BuggedCustomActionMessage: "Geth Juggernaut Melee is currently bugged and it WILL NOT WORK.",
	},
	{
		ID:                  "SoldierGeth",
		IDLook:              "GethDefault",
	...
	{
		ID:          "SoldierKrogan",
		IDLook:      "KroganDefault",
		Name:        "Krogan Soldier",
		SubClass:    "Soldier",
		Species:     []Species{SpeciesKrogan},
		PictureFile: "MP_Krogan0.webp",
		...
		RootPath:    "BioChar_MPPlayers.Archetypes.Soldier",
		VoiceIDs:    []string{"SoldierKrogan"},
	},
	{
		ID:          "AdeptKrogan",
		IDLook:      "KroganArmored",
		Name:        "Krogan Adept",
		SubClass:    "Adept",
		Species:     []Species{SpeciesKrogan},
		PictureFile: "MP_KroganADP.webp",
		...
		RootPath:    "BioChar_DLC_MP4_MPPlayers",
		ArchetypeID: "Adept_Krogan",
		VoiceIDs:    []string{"SoldierKrogan"},
	},
	{
		ID:          "SentinelKrogan",
		IDLook:      "KroganDefault",
		Name:        "Krogan Sentinel",
		SubClass:    "Sentinel",
		Species:     []Species{SpeciesKrogan},
		PictureFile: "MP_Krogan0.webp",
	...
	},
	{
		ID:                  "VanguardKrogan",
		IDLook:              "KroganArmored",
		Name:                "Krogan Battlemaster",
		SubClass:            "Vanguard",
		Species:             []Species{SpeciesKrogan},
		PictureFile:         "MP_KroganBM.webp",
		...
		RootPath:            "BioChar_DLC_MP1_MPPlayers.Archetypes",
		ArchetypeID:         "Krogan_Vanguard",
		VoiceIDs:            []string{"SoldierKrogan"},
		HasUniqueHeavyMelee: true,
		HasUniqueLightMelee: true,
	},
	{
		ID:                        "SentinelKroganWarlord",
		IDLook:                    "KroganWarlord",
		Name:                      "Krogan Warlord",
		SubClass:                  "Sentinel",
		Species:                   []Species{SpeciesKrogan},
		PictureFile:               "MP_BloodSEN.webp",
		...
		RootPath:                  "BioChar_DLC_MP5_MPPlayers",
		ArchetypeID:               "Sentinel_KroganWarlord",
		VoiceIDs:                  []string{"SoldierKrogan"},
		HasUniqueHeavyMelee:       true,
		HasUniqueLightMelee:       true,
		BuggedHeavyMelee:          true,
		BuggedLightMelee:          true,
		BuggedCustomActionMessage: "The Heavy and Light Melee powers fire, but there's no Hammer, and they seem to do little damage as a result.",
	},
	...
	// ---- Mercenary ---------------------------------------------------------
	{
		ID:                  "EngineerMerc",
		IDLook:              "",
		Name:                "Blue Suns Engineer",
		SubClass:            "Engineer",
		Species:             []Species{SpeciesHuman},
		PictureFile:         "MP_MercENG.webp",
	...
	{
		ID:          "EngineerQuarian",
		IDLook:      "QuarianFemaleDefault",
		Name:        "Quarian Engineer",
		SubClass:    "Engineer",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "MP_Quarian0.webp",
		...
		RootPath:    "BioChar_MPPlayers.Archetypes.Engineer",
		VoiceIDs:    []string{"EngineerQuarian"},
	},
	{
		ID:          "InfiltratorQuarian",
		IDLook:      "QuarianFemaleDefault",
		Name:        "Quarian Infiltrator",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "MP_Quarian0.webp",
	...
	},
	{
		...
		IDLook:      "QuarianMaleDefault",
		Name:        "Quarian Male Infiltrator",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "MP_QuarianMale0.webp",
		...
		VoiceIDs:    []string{"InfiltratorQuarianMale"},
	},
	{
		ID:          "EngineerQuarianMale",
		IDLook:      "QuarianMaleDefault",
		Name:        "Quarian Male Engineer",
		SubClass:    "Engineer",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "MP_QuarianMale0.webp",
		...
		RootPath:    "BioChar_DLC_MP2_MPPlayers.Archetypes",
		ArchetypeID: "QuarianMale_Engineer",
		VoiceIDs:    []string{"InfiltratorQuarianMale"},
	},
	{
		ID:          "SoldierMQuarian",
		IDLook:      "QuarianMaleDefault",
		Name:        "Quarian Male Soldier",
		SubClass:    "Soldier",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "MP_QuarianMSLD.webp",
	...
	{
		ID:          "EngineerSalarian",
		IDLook:      "SalarianDefault",
		Name:        "Salarian Engineer",
		SubClass:    "Engineer",
		Species:     []Species{SpeciesSalarian},
		PictureFile: "MP_Salarian0.webp",
	...
	{
		ID:          "SoldierTurian",
		IDLook:      "TurianDefault",
		Name:        "Turian Soldier",
		SubClass:    "Soldier",
		Species:     []Species{SpeciesTurian},
		PictureFile: "MP_Turian0.webp",
		...
		RootPath:    "BioChar_MPPlayers.Archetypes.Soldier",
		VoiceIDs:    []string{"SoldierTurian"},
	},
	{
		ID:          "EngineerTurian",
		IDLook:      "TurianArmiger",
		Name:        "Turian Engineer",
		SubClass:    "Engineer",
		Species:     []Species{SpeciesTurian},
		PictureFile: "MP_TurianENG.webp",
		...
		RootPath:    "BioChar_DLC_MP4_MPPlayers",
		ArchetypeID: "Engineer_Turian",
		VoiceIDs:    []string{"SoldierTurian"},
	},
	{
		ID:          "N7InfiltratorTurian",
		IDLook:      "TurianArmiger",
		Name:        "Turian Infiltrator",
		SubClass:    "Infiltrator",
		Species:     []Species{SpeciesTurian},
		PictureFile: "MP_TurianINF.webp",
		...
		RootPath:    "BioChar_DLC_MP4_MPPlayers",
		ArchetypeID: "Infiltrator_N7_Turian",
		VoiceIDs:    []string{"SoldierTurian"},
	},
	{
		ID:          "SentinelTurian",
		IDLook:      "TurianDefault",
		Name:        "Turian Sentinel",
		SubClass:    "Sentinel",
		Species:     []Species{SpeciesTurian},
		PictureFile: "MP_Turian0.webp",
	...
	},
	{
		...
		VoiceIDs:            []string{"VanguardTurianFemale"},
		HasUniqueHeavyMelee: true,
		HasUniqueDodge:      true,
		HasUniqueLightMelee: true,
		BuggedHeavyMelee:    true,
	...
	// ---- Volus -------------------------------------------------------------
	{
		...
		Name:                "Volus Adept",
		SubClass:            "Adept",
		Species:             []Species{SpeciesVolus},
		PictureFile:         "MP_VolusADP.webp",
	...
	},
	{
		...
		RootPath:    "BioChar_DLC_MP4_MPPlayers",
		ArchetypeID: "Engineer_Volus",
	},
	{
		ID:          "SentinelVolus",
		IDLook:      "VolusDefault",
		Name:        "Volus Engineer II",
		SubClass:    "Sentinel",
		Species:     []Species{SpeciesVolus},
		PictureFile: "MP_VolusENG2.webp",
	...
	{
		ID:                        "EngineerVorcha",
		IDLook:                    "VorchaDefault",
		Name:                      "Vorcha Engineer",
		SubClass:                  "Engineer",
		Species:                   []Species{SpeciesVorcha},
		PictureFile:               "MP_VorchaENG.webp",
		...
		HasUniqueDodge:            true,
		BuggedHeavyMelee:          true,
		BuggedCustomActionMessage: "The Heavy Melee works, but the Sound Effects played are that of a Vorcha.",
	},
	{
		ID:          "SoldierVorcha",
		IDLook:      "VorchaDefault",
	...
	// ---- Armax -------------------------------------------------------------
	{
		ID:          "Char_SimHenchmen.SimJack",
		IDLook:      "",
		Name:        "Jack",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/AAA_CSC_-_A_-_Jack.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimLiara",
		IDLook:      "",
		Name:        "Liara",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesAsari},
		PictureFile: "/SP/Liara0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimSamara",
		IDLook:      "",
		Name:        "Samara",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesAsari},
		PictureFile: "/SP/AAA_CSC_-_A_-_Samara.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimGarrus",
		IDLook:      "",
		Name:        "Garrus",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesTurian},
		PictureFile: "/SP/Garrus0GlowCropped.png",
	...
	{
		ID:          "Char_APP01_Henchmen.Garrus_Combat",
		IDLook:      "",
		Name:        "Garrus (Terminus)",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesTurian},
		PictureFile: "/SP/Garrus3GlowCropped.png",
		PowerIDs:    [5]string{"SFXPowerCustomAction_ConcussiveShot", "SFXPowerCustomActionMP_Overload", "SFXPowerCustomAction_ArmorPiercingAmmo", "SFXPowerCustomActionMP_ProximityMine", "SFXPowerCustomAction_GarrusPassive"},
		HasHeadgear: false,
		HasHelmet:   true,
		PawnType:    PawnTypeHenchman,
	...
	{
		ID:          "Char_SimHenchmen.SimTali",
		IDLook:      "",
		Name:        "Tali",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesQuarian},
		PictureFile: "/SP/Tali0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimWrex",
		IDLook:      "",
		Name:        "Wrex",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesKrogan},
		PictureFile: "/SP/AAA_CSC_-_A_-_Wrex.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimMiranda",
		IDLook:      "",
		Name:        "Miranda",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/AAA_CSC_-_A_-_Miranda.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimKaidan",
		IDLook:      "",
		Name:        "Kaidan",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/Kaidan0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimJacob",
		IDLook:      "",
		Name:        "Jacob",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/Jacob.png",
	...
	{
		ID:          "Char_SimHenchmen.SimAshley",
		IDLook:      "",
		Name:        "Ashley",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/Ashley0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimEDI",
		IDLook:      "",
		Name:        "EDI",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesAndroid},
		PictureFile: "/SP/EDI0GlowCropped.png",
		...
		HasHelmet:   false,
		PawnType:    PawnTypeHenchman,
		VoiceIDs:    []string{"AdeptHumanFemale", "AdeptAsari", "InfiltratorFembot"},
	},
	{
		ID:          "Char_SimHenchmen.SimGrunt",
		IDLook:      "",
		Name:        "Grunt",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesKrogan},
		PictureFile: "/SP/AAA_CSC_-_A_-_Grunt.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimKasumi",
		IDLook:      "",
		Name:        "Kasumi",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/AAA_CSC_-_A_-_Kasumi.webp",
	...
	{
		ID:          "Char_SimHenchmen.SimJames",
		IDLook:      "",
		Name:        "James",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/James0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimJavik",
		IDLook:      "",
		Name:        "Javik",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesProthean},
		PictureFile: "/SP/Prothean0GlowCropped.png",
	...
	{
		ID:          "Char_SimHenchmen.SimZaeed",
		IDLook:      "",
		Name:        "Zaeed",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/AAA_CSC_-_A_-_Zaeed.webp",
	...
	{
		ID:          "Char_Henchmen.Archetypes.Kaidan.VariantB.KaidanB_EX_Combat",
		IDLook:      "",
		Name:        "Kaidan (ALT)",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesHuman},
		PictureFile: "/SP/Kaidan1GlowCropped.png",
		PowerIDs:    [5]string{"SFXPowerCustomActionMP_Barrier", "SFXPowerCustomActionMP_Reave", "SFXPowerCustomActionMP_Overload", "SFXPowerCustomActionMP_CryoBlast", "SFXPowerCustomAction_KaidenPassive"},
		HasHeadgear: false,
		HasHelmet:   true,
		PawnType:    PawnTypeHenchman,
	...
	{
		ID:          "Archetypes.Nyreen_Combat",
		IDLook:      "Nyreen",
		Name:        "Nyreen (No Hood)",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesTurian},
		PictureFile: "/SP/NyreenMassEffect.webp",
	...
	{
		ID:          "Archetypes.Nyreen_Civilian_Combat",
		IDLook:      "Nyreen_Hooded",
		Name:        "Nyreen (Hood)",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesTurian},
	...
	{
		ID:          "Archetypes.Aria_Combat",
		IDLook:      "Aria",
		Name:        "Aria",
		SubClass:    "Squadmate",
		Species:     []Species{SpeciesAsari},
		PictureFile: "/SP/AriaMassEffect.webp",
