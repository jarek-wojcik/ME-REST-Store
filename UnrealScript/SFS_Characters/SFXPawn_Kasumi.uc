Class SFXPawn_Kasumi extends SFXPawn_Henchman_Citadel
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_SMG_Hurricane')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'DLC_MPImages.GUI_Portrait.Icon_Kasumi'
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_Cloak_Kasumi', Class'SFXPowerCustomAction_Overload', Class'SFXPowerCustomAction_ArmorPiercingAmmo', Class'SFXPowerCustomAction_Decoy', Class'SFXPowerCustomAction_KasumiPassive')
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 3.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Decoy', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Decoy', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Cloak_Kasumi', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Decoy', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_KasumiPassive', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 4.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 5.0, EvolvedChoice = 3}, 
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_Cloak_Kasumi', 
                                None, 
                                Class'SFXPowerCustomAction_KasumiPassive', 
                                None, 
                                None, 
                                None, 
                                None, 
    ...
    CombatVocVariants = (SFXVocalizationBank'AIBarks_DLC_Shared.global_kasumi')
    HeadMesh = HeadMesh0
