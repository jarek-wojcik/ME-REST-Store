Class SFXPawn_Marine extends SFXPawn_Henchman
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_AssaultRifle_LMG')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'GUI_Icons.CharacterPortraits.Icon_James0'
    PowerUnlockRequirements = ({RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_FragGrenade', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}, 
                               {RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_Carnage', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}
                              )
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_Fortification', Class'SFXPowerCustomAction_FragGrenade', Class'SFXPowerCustomAction_IncendiaryAmmo', Class'SFXPowerCustomAction_Carnage', Class'SFXPowerCustomAction_JimmyPassive')
    StartingPowerRanks = ({PowerClass = Class'SFXPowerCustomAction_Fortification', Rank = 1.0}
                         )
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_Fortification', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Carnage', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_FragGrenade', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Carnage', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Fortification', Rank = 5.0, EvolvedChoice = 3}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Fortification', Rank = 6.0, EvolvedChoice = 4}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_FragGrenade', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_IncendiaryAmmo', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_IncendiaryAmmo', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_JimmyPassive', Rank = 6.0, EvolvedChoice = 4}
                      )
    PrettyName = $500147
    ...
    CustomActionClasses = (None, 
                           ...
                           None, 
                           None, 
                           Class'SFXCustomAction_HenchmanHeavyMelee', 
                           None, 
                           None, 
                           None, 
                           None, 
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_JimmyPassive'
                               )
    CombatVocVariants = (SFXVocalizationBank'VocalizationBanks.hench_marine')
    HeadMesh = HeadMesh0
    m_oHairMesh = HairMesh0
    m_oHeadGearMesh = GearMesh0
    LightEnvironment = BioLightEnvComponent0
    ExplorationVoc = SFXVocalizationBank'VocalizationBanks.hench_marine_NonCombat'
    StealthVoc = SFXVocalizationBank'VocalizationBanks.hench_marine_Stealth'
