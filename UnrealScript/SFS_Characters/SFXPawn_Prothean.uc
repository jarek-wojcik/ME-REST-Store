Class SFXPawn_Prothean extends SFXPawn_Henchman
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_AssaultRifle_Prothean')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'GUI_Icons.CharacterPortraits.Icon_Prothean0'
    PowerUnlockRequirements = ({RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}, 
                               {RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}
                              )
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_DarkChannel', Class'SFXPowerCustomAction_LiftGrenade', Class'SFXPowerCustomAction_Pull', Class'SFXPowerCustomAction_Slam', Class'SFXPowerCustomAction_ProtheanPassive')
    StartingPowerRanks = ({PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 1.0}
                         )
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DarkChannel', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_LiftGrenade', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Slam', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProtheanPassive', Rank = 6.0, EvolvedChoice = 4}
                      )
    PrettyName = $500142
    ...
    PowerCustomActionClasses = (None, 
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_Pull', 
                                None, 
                                None, 
                                None, 
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_Slam', 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_ProtheanPassive', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_DarkChannel'
                               )
    CombatVocVariants = (SFXVocalizationBank'VocalizationBanks.hench_prothean')
    HeadMesh = HeadMesh0
    m_oHairMesh = HairMesh0
    m_oHeadGearMesh = GearMesh0
    LightEnvironment = BioLightEnvComponent0
    ExplorationVoc = SFXVocalizationBank'VocalizationBanks.hench_prothean_NonCombat'
    StealthVoc = SFXVocalizationBank'VocalizationBanks.hench_prothean_Stealth'
