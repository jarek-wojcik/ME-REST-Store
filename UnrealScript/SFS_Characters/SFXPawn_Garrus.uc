Class SFXPawn_Garrus extends SFXPawn_Henchman
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_SniperRifle_BlackWidow')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'GUI_Icons.CharacterPortraits.Icon_Garrus0'
    PowerUnlockRequirements = ({RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}, 
                               {RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}
                              )
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_ConcussiveShot', Class'SFXPowerCustomAction_Overload', Class'SFXPowerCustomAction_ArmorPiercingAmmo', Class'SFXPowerCustomAction_ProximityMine', Class'SFXPowerCustomAction_GarrusPassive')
    StartingPowerRanks = ({PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 1.0}
                         )
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_ArmorPiercingAmmo', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_ProximityMine', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_GarrusPassive', Rank = 6.0, EvolvedChoice = 4}
                      )
    PrettyName = $178197
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_ArmorPiercingAmmo', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_GarrusPassive', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_ProximityMine'
                               )
    CombatVocVariants = (SFXVocalizationBank'VocalizationBanks.hench_garrus')
    HeadMesh = HeadMesh0
    m_oHairMesh = HairMesh0
    m_oHeadGearMesh = GearMesh0
    LightEnvironment = BioLightEnvComponent0
    ExplorationVoc = SFXVocalizationBank'VocalizationBanks.hench_garrus_NonCombat'
    StealthVoc = SFXVocalizationBank'VocalizationBanks.hench_garrus_Stealth'
    Loadout = HenchLoadout0
    BloodColor = {B = 5, G = 2, R = 2, A = 255}
