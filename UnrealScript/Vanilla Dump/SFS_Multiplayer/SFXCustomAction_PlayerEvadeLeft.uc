Class SFXCustomAction_PlayerEvadeLeft extends SFXCustomAction_PlayerEvadeBase
    config(Game);

var(SFXCustomAction_PlayerEvadeLeft) float MoveDist;
...
defaultproperties
{
    Begin Object Class=SFXTimelineData Name=Timeline0
        ...
        Timeline = ({
                     ...
                     InputHandle = class'SFXCustomAction_PlayerEvadeLeft'.RollOverride, 
                     RumbleClass = None, 
