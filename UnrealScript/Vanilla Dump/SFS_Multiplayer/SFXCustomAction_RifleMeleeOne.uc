Class SFXCustomAction_RifleMeleeOne extends SFXCustomAction_PlayerMeleeBase
    config(Game);

var float BladeImpactScale;
        ...
        if (ImpactedPawn != None && ImpactedPawn.RaceType == ERaceType.RaceType_Humanoid && Weapon.BladeMeleeModImpactEffect != None)
        {
            ...
            if (Pool != None)
            {
                ...
                if (ImpactPSC != None)
                {
                    ...
                    ImpactPSC.SetScale(BladeImpactScale);
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_RifleMeleeOne'.RifleMeleeSecondary, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_RifleMeleeOne'.EndAction, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_RifleMeleeOne'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    bPlayMeleedVoc = TRUE
    BS_Anim = {
               AnimName = ('None', 'CB_RifleAtk1', 'None')
              }
    ...
    OverrideList = (Class'SFXCustomAction_Ragdoll', 
                    ...
                    Class'SFXCustomAction_RifleMeleeTwo', 
