...
public event simulated function HandlePostAdd()
{
    ...
    else
    {
        ...
        Class'SFSInputUtility'.static.SetPCKeyBindInternal(BPI, 'B', sfsUICommand, TRUE, FALSE, FALSE);
    }
}
public function ShowBotChoiceGui()
{
    ...
    //Example choice UI we could use for some SFS operations. Currently not used.
