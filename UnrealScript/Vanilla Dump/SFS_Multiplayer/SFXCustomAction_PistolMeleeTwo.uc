Class SFXCustomAction_PistolMeleeTwo extends SFXCustomAction_PistolMeleeOne
    config(Game);
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline1
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_PistolMeleeTwo'.PistolMeleeThird, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_PistolMeleeTwo'.EndAction, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_PistolMeleeTwo'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    BS_Anim = {
               AnimName = ('CB_PistolMelee2', 'None', 'None')
              }
