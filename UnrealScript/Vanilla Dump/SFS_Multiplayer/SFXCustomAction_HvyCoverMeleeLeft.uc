Class SFXCustomAction_HvyCoverMeleeLeft extends SFXCustomAction_HvyCoverMeleeRight
    config(Game);

public function NonSyncedAction()
{
    Super.NonSyncedAction();
    SetReachPreciseDestination(m_oPawn.location + (Vector(m_oPawn.Rotation) >> rot(0, -8192, 0)) * float(200));
}
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline2
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     CamPlayRate = 1.0, 
                     CamDuration = 0.0, 
                     RVR_CrustTemplate = RvrClientEffectMulti'BioVFX_T_Melee.VCFX.Grab_Melee_SDR_Right_M_VCFX', 
                     CEStartIndex = 0, 
                     GameEffectDuration = 0.0, 
                     GameEffectValue = 0.0, 
                     bActivated = FALSE, 
    ...
    SyncCone = 0.5
    BS_Anim = {
               AnimName = ('CB_MidCoverMeleeLeft')
              }
    PlayerCameraMode = Class'SFXCameraMode_CoverMeleeLeft'
