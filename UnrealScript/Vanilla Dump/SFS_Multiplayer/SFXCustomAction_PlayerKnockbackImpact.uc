Class SFXCustomAction_PlayerKnockbackImpact extends SFXCustomAction_DamageReaction
    config(Game);
...
defaultproperties
{
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                     ...
                     BlurOpacity = 1.0, 
                     CamAnim = CameraAnim'BioVFX_C_CamAnim.Damage.DG_Impact_Body_Backward01', 
                     CamStartTime = 0.0, 
