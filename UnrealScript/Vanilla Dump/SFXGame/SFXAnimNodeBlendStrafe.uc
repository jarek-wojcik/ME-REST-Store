Class SFXAnimNodeBlendStrafe extends AnimNodeBlendBase
    native;
...
var(SFXAnimNodeBlendStrafe) const Name SynchGroupName;
var(SFXAnimNodeBlendStrafe) const float BlendSpeed;
var(SFXAnimNodeBlendStrafe) const float IdleRelativePos;
var(SFXAnimNodeBlendStrafe) const float IdleAngle;
var transient float DirAngle;
var transient int HighestIndex;
...
defaultproperties
{
    ...
    NodeName = 'SFXAnimNodeBlendStrafe'
}