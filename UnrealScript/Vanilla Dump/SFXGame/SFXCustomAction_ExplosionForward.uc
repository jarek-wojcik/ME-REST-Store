Class SFXCustomAction_ExplosionForward extends SFXCustomAction_SingleAnim
    config(Game);
...
defaultproperties
{
    ...
    End Object
    BS_Anim = {
               AnimName = ('DG_ACTMNT_ExplosionBack')
              }
    fAnimPlayRate = 0.600000024
