Class SFXCustomAction_ExitMountedGun extends SFXCustomAction_SingleAnim
    config(Game);
...
defaultproperties
{
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                     ...
                     PS_Template = None, 
                     CrustDuration = 1.0, 
                     Sound = WwiseEvent'Wwise_Weapons_S_MinigunTurret.Play_wep_s_minigunturret_exit', 
                     PlayerSound = WwiseEvent'Wwise_Weapons_S_MinigunTurret.Play_wep_s_minigunturret_exit', 
                     Rumble = None, 
