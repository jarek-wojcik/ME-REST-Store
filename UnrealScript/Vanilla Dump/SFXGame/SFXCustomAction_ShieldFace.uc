Class SFXCustomAction_ShieldFace extends SFXCustomAction_SingleAnim
    config(Game);

public function EndShieldFaceAction()
{
    EndThisCustomAction();
}
...
defaultproperties
{
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                     ...
                     SocketName = 'None', 
                     Func = 'EndShieldFaceAction', 
                     TimeIndex = 2.20000005, 
                     TimeRemaining = 0.0, 
                     PSC_Instance = None, 
    ...
    End Object
    BS_Anim = {
               AnimName = ('HMM_DG_ShieldFace')
              }
    fAnimPlayRate = 1.25
    fAnimBlendInTime = 0.25
