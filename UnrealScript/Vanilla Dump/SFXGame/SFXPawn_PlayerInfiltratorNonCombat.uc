Class SFXPawn_PlayerInfiltratorNonCombat extends SFXPawn_PlayerNonCombat
    placeable
    config(Game);
...
defaultproperties
{
    ...
    End Template
    Begin Template Class=SFXModule_Wrinkles Name=WrinkleModule
    End Template
    ...
    Begin Template Class=SkeletalMeshComponent Name=HeadMesh0
        ...
        LightEnvironment = BioLightEnvComponent0
    End Template
    PlayerClassName = "SFXGameContent.SFXCharacterClass_Infiltrator"
