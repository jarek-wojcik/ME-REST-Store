Class SFXGameModeWeaponWheel extends SFXGameModeBase within BioPlayerController
    config(Input);

var(SFXGameModeWeaponWheel) config float DisableMoveTime;
...
public exec function ExitWeaponWheel()
{
    Outer.GameModeManager2.DisableMode(4);
}
