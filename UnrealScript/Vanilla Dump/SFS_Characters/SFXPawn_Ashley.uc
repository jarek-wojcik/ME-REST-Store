Class SFXPawn_Ashley extends SFXPawn_Henchman
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_AssaultRifle_Saber')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'GUI_Icons.CharacterPortraits.Icon_Ashley0'
    PowerUnlockRequirements = ({RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}, 
                               {RequiredPowerClass = None, PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 0.0, RequiredLevel = 3, CustomUnlockText = $0}
                              )
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_InfernoGrenade', Class'SFXPowerCustomAction_DisruptorAmmo', Class'SFXPowerCustomAction_ConcussiveShot', Class'SFXPowerCustomAction_Marksman', Class'SFXPowerCustomAction_AshleyPassive')
    StartingPowerRanks = ({PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 1.0}
                         )
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Marksman', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_ConcussiveShot', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_AshleyPassive', Rank = 6.0, EvolvedChoice = 4}
                      )
    PrettyName = $206249
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_DisruptorAmmo', 
                                None, 
                                None, 
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_InfernoGrenade', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_AshleyPassive', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_Marksman'
                               )
    CombatVocVariants = (SFXVocalizationBank'VocalizationBanks.hench_ashley')
    HeadMesh = HeadMesh0
    m_oHairMesh = HairMesh0
    m_oHeadGearMesh = GearMesh0
    LightEnvironment = BioLightEnvComponent0
    ExplorationVoc = SFXVocalizationBank'VocalizationBanks.hench_ashley_NonCombat'
    StealthVoc = SFXVocalizationBank'VocalizationBanks.hench_ashley_Stealth'
