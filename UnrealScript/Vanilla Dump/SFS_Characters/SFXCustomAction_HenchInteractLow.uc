Class SFXCustomAction_HenchInteractLow extends SFXCustomAction_LoopingInteraction
    config(Game);
...
defaultproperties
{
    ...
    BS_InteractionStart = {
                           AnimName = ('WI_FixLowEnter')
                          }
    BS_InteractionLoop = {
                          AnimName = ('WI_FixLowTwitch')
                         }
    BS_InteractionEnd = {
                         AnimName = ('WI_FixLowExit')
                        }
    bHideWeapon = TRUE
