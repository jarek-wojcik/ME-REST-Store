Class SFXPawn_Jacob extends SFXPawn_Henchman_Citadel
    placeable
    config(Game);
...
defaultproperties
{
    ...
    End Template
    m_GUI_Icon = Texture2D'DLC_MPImages.GUI_Portrait.Icon_Jacob'
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_IncendiaryAmmo', Class'SFXPowerCustomAction_LiftGrenade', Class'SFXPowerCustomAction_Barrier', Class'SFXPowerCustomAction_Pull', Class'SFXPowerCustomAction_JacobPassive')
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_IncendiaryAmmo', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_Barrier', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JacobPassive', Rank = 6.0, EvolvedChoice = 4}, 
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_JacobPassive'
                               )
    CombatVocVariants = (SFXVocalizationBank'AIBarks_DLC_Shared.global_jacob')
    HeadMesh = HeadMesh0
