Class SFXPawn_Zaeed extends SFXPawn_Henchman_Citadel
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_AssaultRifle_Lancer')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'DLC_MPImages.GUI_Portrait.Icon_Zaeed'
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_Carnage', Class'SFXPowerCustomAction_ConcussiveShot', Class'SFXPowerCustomAction_DisruptorAmmo', Class'SFXPowerCustomAction_InfernoGrenade', Class'SFXPowerCustomAction_ZaeedPassive')
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_Carnage', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_InfernoGrenade', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Carnage', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_ZaeedPassive', Rank = 6.0, EvolvedChoice = 4}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_DisruptorAmmo', Rank = 6.0, EvolvedChoice = 5}
                      )
    PrettyName = $178205
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_ZaeedPassive'
                               )
    CombatVocVariants = (SFXVocalizationBank'AIBarks_DLC_Shared.global_zaeed')
    HeadMesh = HeadMesh0
