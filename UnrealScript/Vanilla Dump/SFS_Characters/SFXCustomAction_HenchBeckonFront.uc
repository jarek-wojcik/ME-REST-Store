Class SFXCustomAction_HenchBeckonFront extends SFXCustomAction_LoopingInteraction
    config(Game);
...
{
    BS_InteractionStart = {
                           AnimName = ('CB_BeckonForward_Enter')
                          }
    BS_InteractionLoop = {
                          AnimName = ('CB_BeckonForward')
                         }
    BS_InteractionEnd = {
                         AnimName = ('CB_BeckonForward_Exit')
                        }
