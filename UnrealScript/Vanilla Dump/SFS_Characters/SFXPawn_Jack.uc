Class SFXPawn_Jack extends SFXPawn_Henchman_Citadel
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_Pistol_Predator')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'DLC_MPImages.GUI_Portrait.Icon_Jack0'
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_Shockwave', Class'SFXPowerCustomAction_Pull', Class'SFXPowerCustomAction_Warp', Class'SFXPowerCustomAction_WarpAmmo', Class'SFXPowerCustomAction_JackPassive')
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 3.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 5.0, EvolvedChoice = 3}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       {PowerClass = Class'SFXPowerCustomAction_Shockwave', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Pull', Rank = 6.0, EvolvedChoice = 5}, 
                       {PowerClass = Class'SFXPowerCustomAction_JackPassive', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Warp', Rank = 4.0, EvolvedChoice = 1}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_WarpAmmo', Rank = 5.0, EvolvedChoice = 3}, 
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                Class'SFXPowerCustomAction_Shockwave', 
                                None, 
                                None, 
                                None, 
                                None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_JackPassive'
                               )
    CombatVocVariants = (SFXVocalizationBank'AIBarks_DLC_Shared.global_jack')
    HeadMesh = HeadMesh0
