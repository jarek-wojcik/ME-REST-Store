Class SFXPawn_Miranda extends SFXPawn_Henchman_Citadel
    placeable
    config(Game);
...
defaultproperties
{
    ...
    Begin Template Class=SFXLoadoutData Name=HenchLoadout0
        Weapons = (Class'SFXWeapon_Pistol_Phalanx')
        ShieldLoadouts = ({
    ...
    End Template
    m_GUI_Icon = Texture2D'DLC_MPImages.GUI_Portrait.Icon_Miranda'
    SquadScreenPowerOrder = (Class'SFXPowerCustomAction_Overload', Class'SFXPowerCustomAction_Warp', Class'SFXPowerCustomAction_Incinerate', Class'SFXPowerCustomAction_Reave', Class'SFXPowerCustomAction_MirandaPassive')
    AutoLevelUpInfo = ({PowerClass = Class'SFXPowerCustomAction_Overload', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Warp', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Incinerate', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Reave', Rank = 1.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 1.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 2.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 3.0, EvolvedChoice = 0}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 4.0, EvolvedChoice = 1}, 
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 5.0, EvolvedChoice = 2}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_MirandaPassive', Rank = 6.0, EvolvedChoice = 4}, 
                       {PowerClass = Class'SFXPowerCustomAction_Incinerate', Rank = 4.0, EvolvedChoice = 0}, 
                       {PowerClass = Class'SFXPowerCustomAction_Incinerate', Rank = 5.0, EvolvedChoice = 3}, 
                       ...
                       {PowerClass = Class'SFXPowerCustomAction_Reave', Rank = 6.0, EvolvedChoice = 4}
                      )
    PrettyName = $156660
    ...
    PowerCustomActionClasses = (None, 
                                ...
                                None, 
                                None, 
                                Class'SFXPowerCustomAction_MirandaPassive'
                               )
    CombatVocVariants = (SFXVocalizationBank'AIBarks_DLC_Shared.global_miranda')
    HeadMesh = HeadMesh0
