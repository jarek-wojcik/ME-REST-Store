...
var(location) editinline export noclear RawDistributionVector StartLocation;
var(Rotation) editinline export noclear RawDistributionFloat StartRotation;
var(Size) editinline export noclear RawDistributionVector SizeLifeMultiplier;
var(Rotation) editinline export noclear RawDistributionFloat StartRotationRate;
...
defaultproperties
{
    ...
    SizeMultiplyY = TRUE
    SizeMultiplyZ = TRUE
    RequiredModules = ('ParticleModuleLifetime', 
                       'ParticleModuleSize', 
