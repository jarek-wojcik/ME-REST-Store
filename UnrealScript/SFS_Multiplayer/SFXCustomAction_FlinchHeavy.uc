Class SFXCustomAction_FlinchHeavy extends SFXCustomAction_FlinchBase
    config(Game);
...
defaultproperties
{
    Begin Template Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                     ...
                     InputHandle = class'SFXCustomAction_FlinchHeavy'.FlinchActionOverride, 
                     RumbleClass = None, 
    ...
    End Template
    BS_Reaction = {
                   AnimName = ('None', 'None', 'None', 'None', 'None', 'DG_CovMid_Neutral_Duck02')
                  }
    BS_ReactionAlt = {
