Class SFXCustomAction_PistolMeleeOne extends SFXCustomAction_PlayerMeleeBase
    config(Game);
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                     ...
                     InputHandle = class'SFXCustomAction_PistolMeleeOne'.PistolMeleeSecondary, 
                     RumbleClass = None, 
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_PistolMeleeOne'.EndAction, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_PistolMeleeOne'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    bPlayMeleedVoc = TRUE
    BS_Anim = {
               AnimName = ('None', 'CB_PistolMelee1', 'None')
              }
    ...
    OverrideList = (Class'SFXCustomAction_Ragdoll', 
                    ...
                    Class'SFXCustomAction_PistolMeleeTwo', 
