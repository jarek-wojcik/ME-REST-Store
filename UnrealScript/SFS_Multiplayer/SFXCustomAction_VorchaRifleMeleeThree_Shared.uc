Class SFXCustomAction_VorchaRifleMeleeThree_Shared extends SFXCustomAction_VorchaRifleMeleeTwo_Shared
    config(Game);
...
public function ReplicateImpact(BioPawn Target, optional int ImpactCount, optional bool bFirstTarget, optional Vector HitLocation, optional Vector HitNormal, optional int CustomActionReactionType)
{
    if (Target != None)
    {
        ...
        Target.ReplicatedCustomActionImpactInfo.CustomActionType = 77;
...
public function StopCustomAction()
{
    ...
    Super(SFXCustomAction_VorchaRifleMeleeOne_Shared).StopCustomAction();
}
...
public function RifleMeleeThird()
{
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline2
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_VorchaRifleMeleeThree_Shared'.RifleMeleeThird, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_VorchaRifleMeleeThree_Shared'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    BlurScale = 0.349999994
    BlurFalloffExponent = 0.5
    BlurOpacity = 0.349999994
    BlurDuration = 1.10000002
    ApplyBlurEffect = TRUE
    BS_Anim = {
               AnimName = ('CB_VOR_RifleMelee3', 'None', 'None')
              }
    OverrideList = (Class'SFXCustomAction_Ragdoll', 
                    ...
                    Class'SFXCustomAction_VorchaRifleMeleeThree_Shared', 
                    Class'SFXCustomAction_Reload', 
                    Class'SFXCustomAction_VorchaEvadeRight_Shared', 
                    Class'SFXCustomAction_VorchaEvadeLeft_Shared', 
                    Class'SFXCustomAction_VorchaEvadeBackwards_Shared', 
