Class SFXCustomAction_VorchaRifleMeleeTwo_Shared extends SFXCustomAction_VorchaRifleMeleeOne_Shared
    config(Game);
...
public function DoRifleMeleeThree()
{
    ...
    {
        BioPC.StartCustomAction(77, SyncPartner);
    }
}
...
defaultproperties
{
    ...
    Begin Object Class=ForceFeedbackWaveform Name=HitShakeFF0
        Samples = ({Duration = 0.200000003, LeftAmplitude = 75, RightAmplitude = 75, LeftFunction = EWaveformFunction.WF_Constant, RightFunction = EWaveformFunction.WF_Constant}
                  )
    End Object
    ...
    Begin Object Class=SFXTimelineData Name=Timeline1
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_VorchaRifleMeleeTwo_Shared'.RifleMeleeThird, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_VorchaRifleMeleeTwo_Shared'.EndAction, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_VorchaRifleMeleeTwo_Shared'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    BS_Anim = {
               AnimName = ('CB_VOR_RifleMelee2', 'None', 'None')
              }
