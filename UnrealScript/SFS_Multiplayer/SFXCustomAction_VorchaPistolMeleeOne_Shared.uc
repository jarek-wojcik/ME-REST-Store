Class SFXCustomAction_VorchaPistolMeleeOne_Shared extends SFXCustomAction_PlayerMeleeBase
    config(Game);
...
public function bool OnActorImpacted(EPowerResistance Resistance, Actor oImpacted, int nPreviouslyImpacted, Vector HitLocation, Vector HitNormal)
{
    ...
    local float fDummyDamage;
    local Vector vDummyForce;
    ...
    if (Weapon != None && Weapon.bTaserMeleeModApplied && Resistance != EPowerResistance.Resistance_Full)
    {
        if (Weapon.TaserMeleeModImpactEffect != None)
        {
            Class'RvrClientEffectManager'.static.GetClientEffectManager().Play(Weapon.TaserMeleeModImpactEffect, oImpacted);
        }
        if (Weapon.TaserMeleeModImpactSound != None)
        {
            oImpacted.PlaySound(Weapon.TaserMeleeModImpactSound, TRUE);
        }
        ImpactedPawn = BioPawn(oImpacted);
        if (ImpactedPawn != None && ImpactedPawn.RaceType == ERaceType.RaceType_Machine && Weapon.TaserMeleeModStunDuration > float(0))
        {
            Resistance = ImpactedPawn.GetPowerResistance(m_oPawn, HitLocation, HitNormal, fDummyDamage, vDummyForce, Class'SFXDamageType_Power_Control', oImpacted);
            if (Resistance == EPowerResistance.Resistance_None)
            {
                Manager = oImpacted.GetModule(Class'SFXModule_GameEffectManager');
                if (Manager != None)
                {
                    Manager.CreateAndApplyEffect(Class'SFXGameEffect_DisableAI', Name, Weapon.TaserMeleeModStunDuration, 1, 0.0, m_oPawn.Controller);
                }
            }
        }
    }
...
public function ReplicateImpact(BioPawn Target, optional int ImpactCount, optional bool bFirstTarget, optional Vector HitLocation, optional Vector HitNormal, optional int CustomActionReactionType)
{
    if (Target != None)
    {
        ...
        Target.ReplicatedCustomActionImpactInfo.CustomActionType = 78;
...
public function DoPistolMeleeTwo()
{
    ...
    {
        BioPC.StartCustomAction(79, SyncPartner);
    }
}
...
public function PistolMeleeSecondary()
{
    m_oPawn.SetTimer(0.150000006, FALSE, 'HeavyMelee', Self);
}
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline0
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_VorchaPistolMeleeOne_Shared'.PistolMeleeSecondary, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_VorchaPistolMeleeOne_Shared'.EndAction, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_VorchaPistolMeleeOne_Shared'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    bPlayMeleedVoc = TRUE
    DestinationOffset = 120.0
    BS_Anim = {
               AnimName = ('CB_VOR_PistolMelee1', 'None', 'None')
              }
