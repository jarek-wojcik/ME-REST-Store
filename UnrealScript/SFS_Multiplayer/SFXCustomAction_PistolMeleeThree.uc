Class SFXCustomAction_PistolMeleeThree extends SFXCustomAction_PistolMeleeTwo
    config(Game);
...
public function StopCustomAction()
{
    ...
    Super(SFXCustomAction_PistolMeleeOne).StopCustomAction();
}
...
defaultproperties
{
    ...
    Begin Object Class=SFXTimelineData Name=Timeline2
        Timeline = ({
                    ...
                    }, 
                    {
                     ...
                     InputHandle = class'SFXCustomAction_PistolMeleeThree'.PistolMeleeThird, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
                    ...
                    }, 
                    {
                     ...
                     AOEFunc = None, 
                     InputAlias = "Shared_Melee", 
                     InputHandle = class'SFXCustomAction_PistolMeleeThree'.NoHeavyMelee, 
                     RumbleClass = None, 
                     ScreenShakeClass = None, 
                     DamageType = None, 
                     AOEFilterClass = Class'Actor', 
    ...
    BS_Anim = {
               AnimName = ('CB_PistolMelee3', 'None', 'None')
              }
    fAnimPlayRate = 0.899999976
    OverrideList = (Class'SFXCustomAction_Ragdoll', 
                    ...
                    Class'SFXCustomAction_PistolMeleeThree', 
                    Class'SFXCustomAction_PlayerEvadeRight', 
                    Class'SFXCustomAction_PlayerEvadeLeft', 
                    Class'SFXCustomAction_PlayerEvadeBackwards', 
                    Class'SFXCustomAction_PlayerEvadeForward', 
